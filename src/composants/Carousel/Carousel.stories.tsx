...
export const WithSmallCards: Story = {
  render: (args) => (
    <div style={{ width: '100%', display: 'flex', justifyContent: 'center' }}>
      <Carousel {...args} sx={{ width: '100%', maxWidth: 600 }}>
        <TrendingCard image="publishers_1.webp" quantityPlaying={1234} link="https://example.com" />
        <TrendingCard image="publishers_2.webp" quantityPlaying={5678} link="https://example.com" />
        <TrendingCard image="publishers_3.webp" quantityPlaying={91011} link="https://example.com" />
        <TrendingCard image="publishers_4.webp" quantityPlaying={1213} link="https://example.com" />
        <TrendingCard image="publishers_5.webp" quantityPlaying={1415} link="https://example.com" />
        <TrendingCard image="publishers_6.webp" quantityPlaying={1617} link="https://example.com" />
        <TrendingCard image="publishers_7.webp" quantityPlaying={1819} link="https://example.com" />
        <TrendingCard image="publishers_8.webp" quantityPlaying={2021} link="https://example.com" />
      </Carousel>
    </div>
  ),
}
